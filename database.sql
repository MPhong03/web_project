...
create table CongTy(
	...
	linkava varchar(500) not null default "",
	linhvuc varchar(100) not null default "",
	thanhpho varchar(100) not null default "",
...
(5, 'Đại học Tôn Đức Thắng', '19, Nguyễn Hữu Thọ, Quận 7', 'tdtu.com', 'Chúng ta đang đi trên con đường đầy hoa và nắng, biết bao tự hào là sinh viên của Tôn Đức Thắng. ', '../../../src/assets/Images/avaAdmin/TDTU.png', 'Giáo dục', 'Thành phố Hồ Chí Minh', 'Mức lương và thu nhập hấp dẫn\r\nMôi trường làm việc sáng tạo');
...
(1, 'Đặng Minh Phong', '../../../src/assets/Images/avaClient/dummy_team_member.png', 'Lập trình viên', '2003-10-26', 1, 0, 'Công nghệ - thông tin', 'Thành phố Hồ Chí Minh', 'Tôn Đức Thắng', 'Lập trình', '12/12', 'Lập trình', '2 năm với Java', 'Something...', 'java,.net,c#,php'),
