...
class C_InfoUser
{
    ...
    public function getAll()
    {
        ...
        while ($r = $user->fetch_assoc()) {
            $data[] = ["hoten" => $r["hoten"], "ngoaingu" => $r["ngoaingu"], "linkava" => $r["linkava"], "congviec" => $r["congviec"], "ngaysinh" => $r["ngaysinh"], "gioitinh" => $r["gioitinh"], "linhvuc" => $r["linhvuc"], "diachi" => $r["diachi"], "muctieunghenghiep" => $r["muctieunghenghiep"], "hocvan" => $r["hocvan"], "kinang" => $r["kinang"], "kinhnghiemlamviec" => $r["kinhnghiemlamviec"], "ngoaingu" => $r["ngoaingu"], "chitiet" => $r["chitiet"], "tagkinang" => $r["tagkinang"], "sdt" => $r["sdt"], "email" => $r["email"]];
        }
        echo json_encode($data[0]);
    }
