        ...
        <div class="ds-row-content3">
          ...
          <div class="filter-dropdown">
            <div class="filter-dropdown-container">
              ...
              <button class="btn-filter-dropdown" id="btn-filterdropdown" aria-haspopup="true" aria-expanded="false"
              ...
              <ul class="filter-dropdownlist filter-dropdownlist-linhvuc" id="filter-menu">
                <input class="form-control myInputSearch" id="myInput2" type="text" autocomplete="off"
                  placeholder="Search..">
            ...
            <div class="filter-dropdown-container">
              <button class="btn-filter-dropdown" id="btn-filterdropdown1" aria-haspopup="true" aria-expanded="false"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 25.595 25.595">
                  <path id="ic_euro_symbol_24px"
                    d="M20.063,25.04a9.214,9.214,0,0,1-8.19-4.977h8.19V17.22H10.934a8.944,8.944,0,0,1,0-2.844h9.129V11.532h-8.19A9.225,9.225,0,0,1,26.078,8.787L28.6,6.27a12.779,12.779,0,0,0-20.59,5.261H3v2.844H7.351a11.892,11.892,0,0,0,0,2.844H3v2.844H8.005A12.779,12.779,0,0,0,28.6,25.325l-2.531-2.517A9.108,9.108,0,0,1,20.063,25.04Z"
              ...
              <ul class="filter-dropdownlist filter-dropdownlist-mucluong" id="filter-menu1">
                <input class="form-control myInputSearch" id="myInput3" autocomplete="off" type="text"
                  placeholder="Search..">
                <li class="filter-dropdownlistItem">
                  <div class="filter-dropdownlistitemLink">Tất cả</div>
                </li>
          ...
          <div class="filter-dropdown">
            <div class="filter-dropdown-container">
              <button class="btn-filter-dropdown" id="btn-filterdropdown2" aria-haspopup="true" aria-expanded="false"
                aria-controls="filter-menu">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" class="bi bi-clock"
                  viewBox="0 0 16 16">
              ...
              <ul class="filter-dropdownlist filter-dropdownlist-hinhthuc" id="filter-menu2">
                <input class="form-control myInputSearch" id="myInput4" autocomplete="off" type="text"
                  placeholder="Search..">
                <li class="filter-dropdownlistItem">
                  <div class="filter-dropdownlistitemLink">Tất cả</div>
                </li>
          ...
          <div class="filter-dropdown">
            <div class="filter-dropdown-container">
              ...
              <ul class="filter-dropdownlist filter-dropdownlist-diadiem" id="filter-menu3">
                <input class="form-control myInputSearch" id="myInput5" autocomplete="off" type="text"
                  placeholder="Search..">
                <li class="filter-dropdownlistItem">
                  <div class="filter-dropdownlistitemLink">Tất cả</div>
                </li>
          ...
          <div class="filter-dropdown-icon">
            <button class="btn-filter-dropdown" id="btn-filterdropdown4" aria-haspopup="true" aria-expanded="false"
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-filter"
                viewBox="0 0 16 16">
                <path
