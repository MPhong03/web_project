<div id="content" class="container-pageinfouser">
                                    ...
                                    <div class="col-md-4 gradient-custom text-center text-white">
                                        <div class="img-userxinviec-right">
                                            <button title="Đổi Avatar" id="avatarInfo" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" style="border:none;background-color: transparent;">
                                                <span><img class="format-img-userxinviec-right img-fluid my-5" src="../../assets/Images/profile.png" alt=""></span>
                                                <div class="middle">
                                        ...
                                        <div class="card-body p-4">
                                            ...
                                            <div class="row pt-1">
                                                ...
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <p class="text-secondary">12-07-2003</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6><i class="bi bi-people-fill"></i>&nbspGiới tính</h6>
                                                    <p class="text-secondary">Nữ</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6><i class="bi bi-geo-alt-fill"></i>&nbspĐịa chỉ</h6>
                                                    <p class="text-secondary">Quảng Nam</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6><i class="bi bi-envelope-fill"></i>&nbspEmail</h6>
                                                    <p class="text-secondary">cobehattieu@gmail.com</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row pt-1">
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <p class="text-secondary">Đại học</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Kỹ năng</h6>
                                                    <p class="text-secondary">Pet 140</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Kinh nghiệm làm việc</h6>
                                                    <p class="text-secondary">2 năm</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                    <h6>Lĩnh vực</h6>
                                                    <p class="text-secondary">Công nghệ thông tin</p>
                                                </div>
                                                <div class="col-6 mb-3">
                                                ...
                                                <div class="col-6 mb-3">
                                                    ...
                                                    <p class="text-secondary">code bằng cả trái tim</p>
                                                </div>
                                            </div>
